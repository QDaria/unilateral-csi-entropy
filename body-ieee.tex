...
Beyond the free tier, pay-as-you-go pricing is approximately \$1.60 per second of quantum processing time as of 2026-Q1.\footnote{IBM Quantum pricing, \url{https://www.ibm.com/quantum/pricing}. Rates are subject to change; figures cited here reflect IBM's published pay-as-you-go rate at the time of writing.}
...
Zhang~\etal~\cite{zhang2016csikey} provided a survey of the field, identifying quantization, reconciliation, and privacy amplification as the three standard phases.
Avrahami~\etal~\cite{avrahami2023csi} demonstrated CSI-based key agreement on modern commodity hardware.

Xiao~\etal~\cite{xiao2024securing} provide a 2024 survey of physical-layer key generation; every system surveyed operates in the bilateral mode, and none apply NIST SP~800-90B entropy assessment.
...
Lee and Lee~\cite{lee2019fmtrng} demonstrated FM radio signals as a TRNG for mobile devices.
...
Ma~\etal~\cite{ma2016qrng} and Herrero-Collantes and Garcia-Escartin~\cite{herrero2017qrng} provide reviews of QRNG.
